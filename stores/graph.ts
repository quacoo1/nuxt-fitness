import type { WorkoutFromDatasource } from '~/types/fitness.types'
import type { GraphData, GraphDataIterator } from '~/types/graph.types'
...
export const useGraphStore = defineStore('graph', () => {
  ...
  async function createGraphData(workouts: WorkoutFromDatasource | any) {
  ...
  async function getGraphMonthlyAverage() {
  ...
  return { getGraphPie, getGraphMonthlyAverage }
})
